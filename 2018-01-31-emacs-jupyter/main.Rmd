...
[post](http://blog.leg.ufpr.br/archives/363), neste abordaremos o uso
...
Basta executar o comando abaixo no terminal do Linux.
...
atalhos e ferramentas do próprio Emacs. Eu, por exemplo, costumo utilizar
...
abra seu `~/.emacs` e insira essas instruções para habilitar o Ein:
...
No Spacemacs, basta habilitar a layer ipython-notebook no 
arquivo `~/.spacemacs` e reiniciar o programa. Dessa forma,
 o Ein já será instalado e configurado automaticamente.
...
no mini-buffer o caminho para o diretório que queremos iniciar o Jupyter Notebook.
...
Se já houver um arquivo do Jupyter Notebook (.ipynb) no seu sistema, 
basta clicar sobre ele para que abra para edição.
